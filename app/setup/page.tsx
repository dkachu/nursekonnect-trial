...
import { Loader2, Activity, ShieldCheck, ShieldAlert, Navigation, MapPin } from "lucide-react";
...
export default function ProfileSetupPage() {
  ...
  useEffect(() => {
    // Defensively schedule structural allocation updates out of the paint timeline
    queueMicrotask(() => {
      setMounted(true);
    });
